...
export const media: Record<string, any> = {
    logo: logo,
    ...
    templates_classic: "/templates/classic.png",
    templates_creative: "/templates/creative.png",
    templates_modern: "/templates/modern.png",
